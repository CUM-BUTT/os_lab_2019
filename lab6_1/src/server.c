...
int main(int argc, char **argv) {
  ...
  //Socket
  //Параметр domain задает домен соединения: выбирает набор протоколов, которые будут использоваться для создания соединения.(AF_INET6	IPv4 протоколы Интернет)
  ...
  //server.sin6_addr.s6_addr = inet6_addr("127.0.0.1"); 
  inet_pton(AF_INET6, "0.0.0.0.0.0.0.1", &server.sin6_addr.s6_addr);
